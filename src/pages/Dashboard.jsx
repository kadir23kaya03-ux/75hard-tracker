...
export default function Dashboard({ user, onLogout }) {
  ...
  const { userData, loading: userLoading, uploading, todayPhoto, toggleTask, completeDay, saveNote, uploadPhoto } = useFirebaseData(user?.id);
          ...
          <div className="border border-[var(--color-dark-border)] bg-[var(--color-dark-card)] overflow-hidden">
            ...
            {todayPhoto ? (
              <div className="relative">
                <img src={todayPhoto} alt={`Gün ${userData.currentDay}`} className="w-full max-h-72 object-cover" />
