...
const WORKOUT_DATA = {
  push: [
    ...
    { num: '02', name: 'İncline Dumbbell Press', detail: 'Üst göğüs vurgusu', sets: '4×8-12' },
    { num: '03', name: 'Overhead Press', detail: 'Omuz ana hareketi', sets: '4×8-12' },
    ...
    { num: '06', name: 'Skull Crusher', detail: 'Triceps uzun baş', sets: '3×12' },
    { num: '07', name: 'Triceps Pushdown', detail: 'Bitiş izolasyonu', sets: '3×12' },
  ],
  pull: [
    { num: '01', name: 'Deadlift', detail: 'Ana güç hareketi — Bele dikkat!', sets: '4×6' },
    ...
    { num: '06', name: 'Barbell Curl', detail: 'Biceps ana hareketi', sets: '4×8-12' },
    { num: '07', name: 'Hammer Curl', detail: 'Brachialis + ön kol', sets: '3×12' },
  ],
  leg: [
...
const WORKOUT_DATA_EXTRA = {
  warmup: [
    ...
    { num: 'COR', name: 'Core & Yer Hareketleri', detail: '25 Bacak Kaldır, 25 Ters Mekik, 40 Yan Mekik, 20 İçeri Mekik, 30sn Ters Kol-Bacak, 50 Dağ Tırmanışı, 15 Mekik Squat, 40sn Sırt Ayak, 10 Diamond Push Up, 10 Dive Bomber, 20 Cobra', sets: '1 Tur' },
    { num: 'BND', name: 'Thera Band Serisi', detail: 'Yana Açış, Önde Açış, İnt Rot, Ext Rot, Öne İtiş, Omuz Ext, Omuz Flex', sets: '1×20' },
  ],
  recovery: [
    { num: '01', name: 'Hollow Body Hold', detail: 'Tüm core kilitli, bel yerde', sets: '4×45-60sn' },
    { num: '02', name: 'V-Ups / Jackknives', detail: 'Üst ve alt karın birlikte', sets: '4×15-20' },
    { num: '03', name: 'Hanging Leg Raise', detail: 'Alt karın izolasyonu', sets: '4×15-20' },
    { num: '04', name: 'Weighted Russian Twist', detail: 'Oblikler, ağırlık ile sağ/sol', sets: '4×20' },
    { num: '05', name: 'Plank to Push-up', detail: 'Omuz stabilizasyonu ve core', sets: '3×16' },
    { num: '06', name: 'Ab Wheel Rollout', detail: 'Anti-ekstansiyon, kontrollü iniş', sets: '3×12-15' },
    { num: '07', name: 'Side Plank', detail: 'Statik oblik dayanıklılığı', sets: '3×45sn' },
  ],
  cooldown: [
    { num: '01', name: 'Chest & Shoulder Stretch', detail: 'Kapı eşiği veya duvarda göğüs açılışı', sets: '2×30sn' },
    { num: '02', name: 'Overhead Triceps & Lat', detail: 'Dirseği arkadan çekerek esneme', sets: '2×30sn' },
    { num: '03', name: 'Cross-Body Shoulder', detail: 'Kolu göğüs hizasında çek', sets: '2×30sn' },
    { num: '04', name: 'Cobra Pose', detail: 'Karın ve bel rahatlatma', sets: '2×30sn' },
    { num: '05', name: "Child's Pose", detail: 'Alt sırtı esnetme', sets: '2×45sn' },
    { num: '06', name: 'Seated Hamstring Stretch', detail: 'Oturarak bacaklara uzanma', sets: '2×30sn' },
    { num: '07', name: 'Standing Quad Stretch', detail: 'Ayakta topuğu kalçaya çek', sets: '2×30sn' },
    { num: '08', name: 'Butterfly Stretch', detail: 'İç bacak esnetme', sets: '2×45sn' },
  ],
};

const ALL_WORKOUT_DATA = { ...WORKOUT_DATA, ...WORKOUT_DATA_EXTRA };
    ...
    <div className="min-h-screen bg-[var(--color-dark)] text-white font-sans selection:bg-red-500/30 overflow-x-hidden">
      ...
      <section id="program" className="py-24 px-6 bg-[#080808] border-y border-[var(--color-dark-border)]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            {ALL_WORKOUT_DATA[activeWorkout].map((ex, idx) => (
