...
const WORKOUT_DATA_EXTRA = {
  ...
  recovery: [
    ...
    { num: 'M01', name: 'Hip CARs', detail: 'Ayakta tek bacak dengesi: Diz yükseğe kaldır, kalçayı tam ROM\'da dışa-içe döndür. Yavaş ve kasılarak.', sets: '2×5/taraf' },
    ...
    { num: 'M03', name: '90/90 Hip Stretch + PAILs', detail: 'Otur, ön ve arka bacak 90°. 2dk pasif bekle, ardından 10sn zemine baskı uygula (PAILs).', sets: '2×2dk/taraf' },
    { num: 'M04', name: 'Bretzel Stretch', detail: 'Yan yat: Alt diz bükük, üst bacak önde — üst kolunu arkaya aç. Thoracic + hip kombine.', sets: '2×45sn/taraf' },
    { num: 'M05', name: 'Jefferson Curl', detail: 'Hafif ağırlıkla (veya boş el): Baştan başlayarak omur omur öne kapan. Spinal traksiyon.', sets: '2×8' },
    ...
    { num: 'M07', name: 'Shoulder CARs', detail: 'Kolları tam ROM\'da omuz ekleminden döndür: Öne–yukarı–arkaya–aşağı. Rotator cuff aktivasyonu.', sets: '2×5/taraf' },
  ],
  cooldown: [
